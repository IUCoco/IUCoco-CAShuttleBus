...
@interface CASBackgroundTaskManager()
...
@implementation CASBackgroundTaskManager

#pragma mark - Single case
+ (instancetype)sharedBackgroundTaskManager{
    static CASBackgroundTaskManager *sharedBGTaskManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedBGTaskManager = [[CASBackgroundTaskManager alloc] init];
    });
